...
REQUIRED_CHANNELS = {
    "channel1": {
        "chat_id": "-1002393608256",  # अपना चैनल ID डालें
        "invite_link": "https://t.me/+GPYh4vMt0_1kNjll"  # अपना इनवाइट लिंक
    },
    "channel2": {
        "chat_id": "-1002346183120",
        "invite_link": "https://t.me/+0nOH4S0clXgyZjA1"
    }
}
...
def create_random_key():
    key = "SHERR-" + ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(10))
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 ┊𝐕𝘪𝕜i x viP┊™ 𝐃𝐃𝐎𝐒 𝐖𝐎𝐑𝐋𝐃!", reply_markup=markup)
